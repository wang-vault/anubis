# Panduan Buyer (pembeli)

Bisa langsung Anda salin ke halaman bantuan toko / kirim ke customer baru.

## 1. Daftar
Buka **Daftar**, isi: nama, email aktif, password (min 8 karakter), dan **nomor
WhatsApp aktif** (contoh 081234567890).
⚠️ Pesanan dikirim lewat WhatsApp ke nomor itu — salah nomor = salah kirim,
dan itu tanggung jawab pembeli (peringatan ada di form).

## 2. Aktivasi email
Setelah mendaftar: **cek inbox (juga folder spam/promotions)** → klik tombol
...
1. status berubah **Sedang Diproses** (cek di **Pesanan Saya**),
2. penjual menghubungi kamu **lewat WhatsApp ke nomor kamu** untuk konfirmasi/
   pengiriman — balas chat itu bila ada alamat/data lain yang diminta,
3. pesanan diterima → penjual tandai selesai.

## 11. Selesai & riwayat
**Pesanan Saya → (buka order)** menampilkan timeline:
